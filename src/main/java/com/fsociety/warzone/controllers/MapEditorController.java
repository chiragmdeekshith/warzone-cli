...
import com.fsociety.warzone.utils.command.constant.MapEditorCommand;
...
public class MapEditorController {
    ...
    public static void showMap() {
        System.out.println("\nMap: " + d_editMap.getFileName());
        System.out.println("--------------------");
        System.out.println("Continents and their bonuses");
        for (Map.Entry<Integer, Integer> entry : d_editMap.getContinentBonuses().entrySet()) {
            System.out.println(entry.getKey() + ": " + entry.getValue().toString());
        }
        System.out.println("--------------------");
        System.out.println("Continents and their Countries");
        for (Map.Entry<Integer, Set<Integer>> entry : d_editMap.getCountriesInContinent().entrySet()) {
            System.out.println(entry.getKey() + ": " + entry.getValue().toString());
        }
        System.out.println("--------------------");
        System.out.println("Borders");
        for (Map.Entry<Integer, Set<Integer>> entry : d_editMap.getNeighbours().entrySet()) {
            System.out.println(entry.getKey() + ": " + entry.getValue().toString());
        }
        System.out.println("--------------------\n");
    }
